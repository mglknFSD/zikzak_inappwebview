    ...
    switch (call.method) {
      ...
      case "onRenderProcessUnresponsive":
        if ((webviewParams != null &&
          ...
          if (webviewParams != null) {
            final onRenderProcessUnresponsive =
                webviewParams!.onRenderProcessUnresponsive;
            if (onRenderProcessUnresponsive != null) {
              onRenderProcessUnresponsive(_controllerFromPlatform);
            }
            return null;
          } else {
            return (await _inAppBrowserEventHandler!
      ...
      case "onRenderProcessResponsive":
        if ((webviewParams != null &&
          ...
          if (webviewParams != null) {
            final onRenderProcessResponsive =
                webviewParams!.onRenderProcessResponsive;
            if (onRenderProcessResponsive != null) {
              onRenderProcessResponsive(_controllerFromPlatform);
            }
            return null;
          } else {
      ...
      case "onFindResultReceived":
        if (webviewParams != null &&
          ...
          webviewParams!
            ...
            _inAppBrowser!.findInteractionController != null &&
...
(function() {
  ...
  Future<Uint8List?> createPdf({PDFConfiguration? pdfConfiguration}) async {
    Map<String, dynamic> args = <String, dynamic>{};
    args.putIfAbsent('settings', () => pdfConfiguration?.toMap());
